...
#define  LOG_TAG    "stev-rtmp-muxer"
...
//            LOGD("sps output %s", *output);
            LOGD("sps output_len %d", output_len);

//            for(int i= 0; i < output_len; i++){
//                LOGD("sps output %s", output[i]);
//            }
