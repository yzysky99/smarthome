package com.smarthome.librtmpsdk.network;
...
//                        String dataData = Arrays.toString(frame.data);
                        String dataData = bytesToHexString(frame.data);
                        Log.d(TAG,"frame.data: " + dataData);
