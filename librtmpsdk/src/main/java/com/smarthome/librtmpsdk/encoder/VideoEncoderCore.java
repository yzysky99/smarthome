...
package com.smarthome.librtmpsdk.encoder;
...
public class VideoEncoderCore {
    private static final String TAG = "stev-VideoEncoderCore";
    ...
    public void drainEncoder(boolean endOfStream) {
        ...
        while (true) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                String dataConfig = Arrays.toString(config);
                Log.d(TAG,"dataConfig: " + dataConfig);
                Log.d(TAG,"dataLength: " + config.length);
                ...
                if (mBufferInfo.size != 0) {
                    ...
                    String dataData = Arrays.toString(data);
//                    Log.d(TAG,"dataData: " + dataData);
//                    Log.d(TAG,"dataLength: " + mBufferInfo.size);
//                    Log.d(TAG,"presetationTime: " + presetationTime);
