package com.smarthome.device.recognization;
...
import com.smarthome.device.utils.Constants;
...
public class MessageStatusRecogListener extends StatusRecogListener {
    private static final String TAG = "MessageStatusRecog";
...
//        msg.what = ASR_RESULT_MSG;
//        msg.obj = results[0];

        speechEndTime = 0;

        Log.d(TAG,"result: " + result);
        sendMessage(result, ASR_RESULT_MSG, true);
    }
