...
public class SoftAPConfigActivity extends AppCompatActivity {
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        setContentView(R.layout.activity_soft_apconfig);
        init();
    }
    ...
    private void init() {
        ...
        if (list == null) {
            Toast.makeText(this, "没有可用Wifi", Toast.LENGTH_LONG).show();
        }else {
...
//                    Toast.makeText(getApplicationContext(),  list.get(arg2).SSID, 3000).show();
                    ...
                    intent.setClass(SoftAPConfigActivity.this, SendWifiKeyActivity.class);
                    SoftAPConfigActivity.this.startActivity(intent);
                    finish();
                }
            });
        }
