    ...
    public void onMessage(Context context, String message,
        ...
        if (!TextUtils.isEmpty(message)) {
            ...
            try {
                ...
                if (!jsonObject.isNull(Constants.DeviceInfo.DEVICE_MSG)) {
                    deviceType = jsonObject.getString(Constants.DeviceInfo.DEVICE_TYPE);
                }

                if (!jsonObject.isNull(Constants.DeviceInfo.DEVICE_MSG)) {
                    deviceMac = jsonObject.getString(Constants.DeviceInfo.DEVICE_MAC);
                }

                if (!jsonObject.isNull(Constants.DeviceInfo.DEVICE_MSG)) {
                    deviceMsg = jsonObject.getString(Constants.DeviceInfo.DEVICE_MSG);
                }
        ...
        sendMessage(messageString, ASR_RESULT_MSG);
    }
...
//        intent.setClass(context.getApplicationContext(), CameraActivity.class);
...
//        context.getApplicationContext().startActivity(intent);
    ...
    private void sendMessage(String message, int what) {
        ...
        if (CameraActivity.msgHandler != null) {
            CameraActivity.msgHandler.sendMessage(msg);
        }
